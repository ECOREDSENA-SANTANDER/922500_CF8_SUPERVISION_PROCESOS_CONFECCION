      ...
      .col-10(data-aos="flip-up")    
        LineaTiempoD.color-secundario
          .row(numero="1" titulo="NTC 2260")
            .col-12
              p.text-small  Pantalones tipo jean y otros pantalones informales; esta norma instituye los requisitos que debe cumplir el confeccionista en cuanto los ensayos de las telas con las cuales se confeccionan los pantalones.

          .row(numero="2" titulo="NTC 2309")
            .col-12
              p.text-small Camisas deportivas (informales) y de traje (formales) para hombres y niños; esta norma cubre la evaluación de características en el lavado casero de tejido plano. 

          .row(numero="3" titulo="NTC 2398-1988")
            .col-12
              p.text-small.text-small Ropa interior femenina de tejido plano; esta norma instaura los requisitos que debe cumplir el confeccionista en cuanto los ensayos de materiales, empaque, rotulado y normas de muestreo con las cuales se confeccionan panty, brasier.
