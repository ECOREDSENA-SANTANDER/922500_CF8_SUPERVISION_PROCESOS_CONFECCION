...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
        ...
        .row.align-items-stretch.justify-content-between.mt-3
          ...
          .col-sm-6.col-lg-3.mb-4.mb-lg-0.tarjeta--boton.p-4.bg-card-2(data-aos="fade-right")
            .row.justify-content-center.mb-3
              .col-8
                figure
                  img.mb-5(src='@/assets/ilustraciones/img40.svg',alt='tema5')
            img.img-t.my-2.mx-5.mb-4(src='@/assets/ilustraciones/img43_2.svg',alt='tema5')               
            .col-lg-2
          ...
          .col-sm-6.col-lg-3.mb-4.mb-sm-0.tarjeta--boton.p-4.bg-card-3(data-aos="fade-left")
            .row.justify-content-center.mb-3
              .col-8
                figure
                  img.mb-5(src='@/assets/ilustraciones/img41.svg',alt='tema5')
            img.img-t.my-2.mx-5.mb-4(src='@/assets/ilustraciones/img43_3.svg',alt='tema5')               
            .col-lg-2
          ...
          .col-sm-6.col-lg-3.tarjeta--boton.p-4.bg-card-4(data-aos="fade-left")        
            .row.justify-content-center.mb-3
              .col-8
                figure
                  img.mb-5(src='@/assets/ilustraciones/img42.svg',alt='tema5')
            img.img-t.my-2.mx-5.mb-4(src='@/assets/ilustraciones/img43_4.svg',alt='tema5')               
            .col-lg-2
                ...
                .row.justify-content-center.align-items-center
                  .col-lg-12
                    ...
                    ImagenInfografica.color-primario.mt-3(data-aos="zoom-in")
                      ...
                      .tarjeta.color-acento-botoones.p-3(x="75%" y="18%")
                        p Determinar metas y objetivos.
                        p Determinar métodos para alcanzar metas.

                      .tarjeta.color-acento-botoones.p-3(x="73%" y="78%")
    ...
    #t_5_3.titulo-segundo
      .h2 5.3 Puntos y controles en el proceso de confección 
