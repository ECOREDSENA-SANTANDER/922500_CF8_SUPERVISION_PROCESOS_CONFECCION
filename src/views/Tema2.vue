...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.fondo-gr.align-items-center.py-4.py-md-3.mb-2
        ...
        .row.justify-content-center(data-aos="fade-down")
          ...
          .row.justify-content-center.align-items-center
            ...
            .col-md-10.col-lg-5.col-10
              img.img-t.img-a.mb-0(data-aos="zoom-in")(src='@/assets/ilustraciones/aa.png', alt='tema2') 
                ...
                .bg34   
                  .row.justify-content-center.align-items-center.mt-4
                    ...
                    .col-lg-6.p-3.my-1 
                      ...
                      p.mb-0 57%: dolor en la espalda.
                      p.mb-0 16%: dolor en las nalgas.
                      p.mb-0 19%: dolor en los muslos.
                      p.mb-0 29%: dolor en rodillas y piernas.   
                  .row.justify-content-center.align-items-center
                    .col-lg-12                        
